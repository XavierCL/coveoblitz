...
function usage(e) {
    ...
    console.error("Usage: %s <-a|-t> <num games> <config>", r), e && console.error(e), process.exit(1)
}
function fatal(e, o) {
...
module.exports = cli, cli.defaultLog = function (e, o) {
    ...
    return r.sort(function (e, o) {
        return o.calories - e.calories
    }), o = e.hero.calories === r[0].calories ? r[0].calories === r[1].calories ? "DRAW" : "WIN" : "LOSS", o + " - " + r.map(function (e) {
        return "P" + e.id + " " + e.name + ": " + e.calories + " ◯"
    }).join(", ")
};